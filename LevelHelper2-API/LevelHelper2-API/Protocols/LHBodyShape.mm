...
+(id)createRectangleWithDictionary:(NSDictionary*)dict body:(b2Body*)body node:(CCNode*)node scene:(LHScene*)scene size:(CGSize)size
{
    return LH_AUTORELEASED([[self alloc] initRectangleWithDictionary:dict body:body node:node scene:scene size:size]);
}

-(id)initRectangleWithDictionary:(NSDictionary*)dict body:(b2Body*)body node:(CCNode*)node scene:(LHScene*)scene size:(CGSize)size
{
    if(self = [super init]){
...
+(id)createCircleWithDictionary:(NSDictionary*)dict body:(b2Body*)body node:(CCNode*)node scene:(LHScene*)scene size:(CGSize)size
{
    return LH_AUTORELEASED([[self alloc] initCircleWithDictionary:dict body:body node:node scene:scene size:size]);
}

-(id)initCircleWithDictionary:(NSDictionary*)dict body:(b2Body*)body node:(CCNode*)node scene:(LHScene*)scene size:(CGSize)size
{
    if(self = [super init]){
...
+(id)createWithDictionary:(NSDictionary*)dict shapePoints:(NSArray*)shapePoints body:(b2Body*)body node:(CCNode*)node scene:(LHScene*)scene scale:(CGPoint)scale
{
...
-(id)initWithDictionary:(NSDictionary*)dict shapePoints:(NSArray*)shapePoints body:(b2Body*)body node:(CCNode*)node scene:(LHScene*)scene scale:(CGPoint)scale
{
    if(self = [super init]){
...
+(id)createChainWithDictionary:(NSDictionary*)dict shapePoints:(NSArray*)shapePoints close:(BOOL)close body:(b2Body*)body node:(CCNode*)node scene:(LHScene*)scene scale:(CGPoint)scale
{
...
-(id)initChainWithDictionary:(NSDictionary*)dict shapePoints:(NSArray*)shapePoints close:(BOOL)close body:(b2Body*)body node:(CCNode*)node scene:(LHScene*)scene scale:(CGPoint)scale
{
    if(self = [super init]){
...
+(id)createWithDictionary:(NSDictionary*)dict triangles:(NSArray*)triangles body:(b2Body*)body node:(CCNode*)node scene:(LHScene*)scene scale:(CGPoint)scale
{
...
-(id)initWithDictionary:(NSDictionary*)dict triangles:(NSArray*)trianglePoints body:(b2Body*)body node:(CCNode*)node scene:(LHScene*)scene scale:(CGPoint)scale
{
    if(self = [super init]){
...
-(id)initWithDictionary:(NSDictionary*)dict body:(b2Body*)body node:(CCNode*)node scene:(LHScene*)scene scale:(CGPoint)scale
{
    if(self = [super init])
    {
