...
@implementation LHAnimationProperty
{
    ...
    __weak CCNode<LHNodeAnimationProtocol, LHNodeProtocol>* subpropertyNode; //the node that is controlled by this subproperty
...
-(void)loadDictionary:(NSDictionary*)dict
{
    ...
    if(subsInfo)
    {
        ...
        for(NSString* subUUID in allKeys){
            ...
            CCNode<LHNodeAnimationProtocol, LHNodeProtocol>* child = (CCNode<LHNodeAnimationProtocol, LHNodeProtocol>*)[parentNode childNodeWithUUID:subUUID];
